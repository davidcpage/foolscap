// /vendor/acorn.js — acorn 8.17.0, the ESM build (dist/acorn.mjs) vendored verbatim (MIT). Used by
// /vendor/notebook-infer.js for the notebook card's same-notebook dependency inference (step-4a,
// docs/notebook-card.md §5/§11.4a): parse a cell's JS, find its free variables + the name it defines.
// We adopt acorn the PARSER only (notebook-kit's own dep, §2) — never @observablehq/runtime. Self-
// contained ESM (no imports), so it loads in the browser at /vendor/, bundles into src via Vite, and
// imports under node in the contract test alike. Regenerate by re-copying node_modules/acorn/dist/acorn.mjs.
//
